...
public class SeedService {
    ...
    public SeedService(SeatRepository seatRepository, EventRepository eventRepository, UserRepository userRepository,
    ...
    private void createSeedEvents(List<User> seedUsers) {
        ...
        List<String> defaultSeats = Arrays.asList(
                "A11", "A12", "A13", "A14", "A15", "B11", "B12", "B13", "B14", "B15", "C11", "C12", "C13", "C14",
                "C15");
        ...
        var event1Raw = new CreateEventRequestDto("Tech Innovation Summit 2025",
                ...
                now.plusDays(1), (short) 15, seedUsers.get(0).getId(), defaultSeats);
        ...
        var event2Raw = new CreateEventRequestDto("Global Sustainability Forum",
                ...
                now.plusDays(1).plusHours(6), (short) 15, seedUsers.get(1).getId(), defaultSeats);
        ...
        var event3Raw = new CreateEventRequestDto("Art & Design Expo",
                ...
                now.plusDays(6).plusHours(2).plusMinutes(30), (short) 15, seedUsers.get(0).getId(), defaultSeats);
